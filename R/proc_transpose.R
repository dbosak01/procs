...
#' @param id The option specifications for the table parameter.
#' @param idlabel The variable(s) to calculate summary statistics for.
#' @param copy A vector of variable to retain in the output data frame
