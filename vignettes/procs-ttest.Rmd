...
very easy to generate.  You can request plots in several ways:
...
A paired analysis will also include a paired profiles chart and an agreemnt
plot.
...
parameters which allow you to specify which charts to show, and whether to show 
them in a summary view or as separate charts. See the `ttestplot()` function
for additional details.

Here are the default plots for a paired T-test:
```{r eval=FALSE, echo=TRUE} 
# Request default plots
proc_ttest(cls, paired = "Weight * Height",
           plots = TRUE)

```

<img src="../man/images/ttest5a.png" alt="Proc reg plots 1"/>
<img src="../man/images/ttest5b.png" alt="Proc reg plots 2"/>
<img src="../man/images/ttest5c.png" alt="Proc reg plots 3"/>
<img src="../man/images/ttest5d.png" alt="Proc reg plots 4"/>
