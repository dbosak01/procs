...
The paired observation test can be used in cases when you have data on the 
same value at different time points, or before and after a procedure. This example
attemps to determine whether there is a significant change in systolic blood
...
Now let's determine if there is a significant change before and after the stimulus measures:
```{r eval=FALSE, echo=TRUE} 
# Perform T-Test
