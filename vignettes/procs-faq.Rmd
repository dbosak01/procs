...
* [Does the package support Cochran-Mantel-Hanzel Statistics?](#cmh)
* [What about PROC COMPARE?](#compare)
* [Are there any other statistics procedure coming?](#other)
...
is to help them become more productive and comfortable working in R in a shorter
amount of time.
...
**Q:** May company requires that all software be validated before using in 
production. Is the **procs** package validated?

**A:** Yes.  The functions were validated by comparing to SAS®. The validation
documentation is [here](https://procs.r-sassy.org/validation.docx).
...
**A:** CMH statistics were left out of the current version because the
corresponding R function does not match SAS® reliably.  You can run CMH statistics
yourself using using the 'mantelhaen.test()' function
...
**A:** There are already several dataset comparison packages in R.  Therefore,
I didn't make it a priority.  Yet several people have asked for it, and it 
...
procedures and the most commonly used.
...
reporting features, see the **reporter** package.
